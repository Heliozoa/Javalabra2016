 ...
 * @author sasami-san
 */
public class TekijaMuutosKuuntelija extends JTextFieldMuutosKuuntelija {

    public TekijaMuutosKuuntelija(Ohjain ohjain, JTextField textField, TietoPaneeli tietoPaneeli) {
        super(ohjain, textField, tietoPaneeli);
    }

    @Override
    protected void muutaArvoa(Teos t, String uusiArvo) {
        t.setTekija(ohjain.haeKirjailijaTaiLuoUusi(uusiArvo));
    }
